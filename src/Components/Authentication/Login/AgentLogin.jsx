...
import UserLoginImg from '../../Images/regUser.jpg';
    ...
    return (
        <div className='container-fluid'>
            ...
            <div className='row'>
                <div className='col-md-12 col-xl-6 col-xxl-6 col-sm-12'>
                    <div className='container w-75 d-flex align-items-center justify-content-center'>
                        <div className='text-primary'>
                            <h2 className='text-center' style={{ textAlign: 'center' }}>Welcome to Cab Routes</h2>
                ...
                <div className='col-md-12 col-xl-6 col-xxl-6 col-sm-12'>
                    <img src={UserLoginImg} style={{ maxWidth: '80%', height: 'auto' }} />
                </div>
            </div>
        </div>
    );
