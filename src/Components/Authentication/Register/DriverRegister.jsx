...
import userRegisterImg from '../../Images/regUser.jpg';
...
const DriverRegister = ({ history }) => {
    ...
    const [regUser, setRegUser] = useState(
        {
            ...
            Password: '',
            Email: '',
            DateOfBirth: '',    // New field: date of birth
            Gender: '',         // New field: gender
            LicenseNumber: '',  // New field: license number
            VehicleNumber: ''   // New field: vehicle number
        }
    )
    ...
    const getData = (e) => {
        ...
        else if (regUser.Gender === '') {
            toast.error("Gender is required", { autoClose: 100000 });
        }
        else if (regUser.LicenseNumber === '') {
            toast.error("License Number is required", { autoClose: 100000 });
        }
        else if (regUser.VehicleNumber === '') {
            toast.error("Vehicle Number is required", { autoClose: 100000 });
        }
                                            ...
                                            <div className='d-flex align-items-center justify-content-center'>
                                                <Form style={{ padding: '5vh' }}>
                                                    ...
                                                    <Form.Group className="mb-3" controlId="formBasicDateOfBirth">
                                                        ...
                                                        <Form.Control className='input-background-color' type="date" onChange={data} name='DateOfBirth' style={{ fontSize: '2vh', padding: '2vh' }} />
                                                    </Form.Group>

                                                    <Form.Group className="mb-3" controlId="formBasicGender">
                                                        <Form.Label>Gender</Form.Label>
                                                        <Form.Control as="select" onChange={data} name='Gender' className='input-background-color' style={{ fontSize: '2vh', padding: '2vh' }}>
                                                    ...
                                                    <Form.Group className="mb-3" controlId="formBasicLicenseNumber">
                                                        ...
                                                        <Form.Control className='input-background-color' type="text" onChange={data} name='LicenseNumber' placeholder="Enter License Number" style={{ fontSize: '2vh', padding: '2vh' }} />
                                                    </Form.Group>

                                                    <Form.Group className="mb-3" controlId="formBasicVehicleNumber">
                                                        <Form.Label>Vehicle Number</Form.Label>
                                                        <Form.Control className='input-background-color' type="text" onChange={data} name='VehicleNumber' placeholder="Enter Vehicle Number" style={{ fontSize: '2vh', padding: '2vh' }} />
                                                    </Form.Group>
