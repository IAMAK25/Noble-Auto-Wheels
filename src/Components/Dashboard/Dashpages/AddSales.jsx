...
import { getDatabase, ref, set, onValue } from 'firebase/database'; // Firebase Realtime Database imports
import './Common.css';
                ...
                <div>
                    <Box component="main" sx={{ flexGrow: 1, p: 3 }} style={{ width: '90vw' }}>
                        ...
                        <div className='form-container'>
                            <h1 className='form-title'>Sales Data</h1>
                            <Form>
                        ...
                        {/* Bike Sales Form */}
                        <div className='form-container'>
                            <h1 className='form-title'>Bike Sales Data</h1>
                            ...
                            <Table striped bordered hover>
                                ...
                                <tbody>
                                    {Object.entries(bikeSales).map(([year, yearData]) => (
                                        Object.entries(yearData).map(([bikeName, bikeData]) => (
                                            Object.entries(bikeData).map(([bikeYear, salesCount]) => (
                                                <tr key={`${year}-${bikeName}`}>
                                                    <td>{bikeName}</td>
                                                    <td>{bikeYear}</td>
                                                    <td>{salesCount}</td>
                                                </tr>
